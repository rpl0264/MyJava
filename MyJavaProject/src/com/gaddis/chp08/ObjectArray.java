...
public class ObjectArray
{
   public static void main(String[] args)
   {
      ...
      for (int index = 0; index < accounts.length; index++)
      {
         ...
         //Total the amount of all accounts
         //totalAmt = totalAmt + accounts[index].getBalance();
         totalAmt += accounts[index].getBalance();
      }
      
       System.out.println("Total for all accounts: " + totalAmt);
